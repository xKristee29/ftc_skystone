...
@TeleOp (name = "CT Kristee",group = "b")
public class CT extends LinearOpMode {
    ...
    public void initHw() {
        ...
        motorGlisiera.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
    ...
    public void runOpMode() {
        ...
        try {
            ...
            while (-TimeUnit.MILLISECONDS.convert(time - System.nanoTime(), TimeUnit.NANOSECONDS) <= 120000) {
                ...
                if(!motorGlisiera.isBusy() && !stateGlisiera){
                    motorGlisiera.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                    motorGlisiera.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                    stateGlisiera = true;
                }
